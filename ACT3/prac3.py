...
class Calculadora():
    def __init__(self):
        ...
        self.principal = Tk()
        self.principal.title("Calculadora cientifica")
        ...
        self.color_boton = "#fff"    #variable para definir color de botones
        self.fuente_btn = ('comic sans', '22')    #define fuente de botones
        self.padx_btn = 2
        self.pady_btn = 2
        self.pady_btn = 2
        self.bg_gral = "#EFEFFB"
        self.fuente_selec = ('Comic Sans', '12')
        ...
        self.caracteres_especiales = ['*', '/', '-', '+', '(', ')'] #lista de caracteres especiales (operadores) presentados en la calculadora
    ...
    def botone(self, estado8a9 ="normal", estado2a7="normal"):  #funcion donde esta el codigo que crea los botones de la calculadora
        ...
        bton_c = Button(self.botones, text="BORRAR", font=self.fuente_btn, bd=self.pady_btn, bg=self.color_boton,
                        ...
                        height=self.alto_boton, command=lambda: self.limpiar_celdas(True)).grid(row=0, column=0,
                                                                                         ...
                                                                                         padx=self.padx_btn,
                                                                                         pady=self.pady_btn)
        bton_power = Button(self.botones, text="OFF", font=self.fuente_btn, bd=self.pady_btn, bg="#fff",
    ...
    def calculadora_bases_numericas(self):  #funcion donde se configura el tamaño de la ventana y contiene los radios y campos de entrada para las conversiones
        ...
        self.marco02 = Frame(self.principal, bg="#fff")
        ...
        self.campo_pantalla = Entry(pantalla, font=('Consolas', 20, 'bold'), width=22, bg="#fff", bd=20,
        ...
        radios = Frame(self.marco02, bg= "#fff")
        radios.pack(fill = X, expand = True, side = TOP, pady=1)

        binarios = Radiobutton(radios, text="Binario", variable=self.base_numeric, bg="#fff", value=1,
        ...
        octaldecimal = Radiobutton(radios, text="Octal decimal", variable=self.base_numeric, bg="#fff", value=2,
                                   font=self.fuente_selec,
        ...
        decimal = Radiobutton(radios, text="Decimal", variable=self.base_numeric, bg="#fff", value=3,
                              font=self.fuente_selec,
        ...
        hexadecimal = Radiobutton(radios, text="Hexadecimal", variable=self.base_numeric, bg="#fff", value=4,
                                  font=self.fuente_selec,
